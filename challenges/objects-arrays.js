...
const tRex = {name: 'tyrannosaurus', diet: 'carnivorous', weight: '7000kg', length: '12m', period: 'Late Cretaceous', rawr: function(){return `RAWERSRARARWERSARARARRRR!`}};
// stegosaurus, herbivorous, 2000kg, 9m, Late Jurassic
const stego = {name: 'stegosaurus', diet: 'herbivorous', weight: '2000kg', length: '9m', period: 'Late Jurassic',}
// velociraptor, carnivorous, 15kg, 1.8m, Late Cretaceous
const raptor = {name: 'velociraptor', diet: 'carinorous', weight: '15kg', length: '1.8m', period: 'Late Cretaceous',}
